  ...
  if (viewMode === 'list') {
    return (
      <Link href={`/products/${product.id}`}>
        ...
        >
          <div className="card-glow overflow-hidden bg-white border border-gray-200 shadow-md hover:shadow-lg">
            <div className="flex">
              <div className="relative w-48 h-48 bg-gray-100 rounded-l-lg overflow-hidden flex-shrink-0">
                <Image
                  src={product.image}
                  alt={product.title}
                  fill
              ...
              <div className="flex-1 p-6 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-semibold text-charcoal group-hover:text-primary-orange transition-colors duration-300 mb-2">
                    {product.title}
                  </h3>
                  <div className="flex items-center space-x-1 mb-3">
                    ...
                    <span className="text-sm text-charcoal-light ml-2">({product.rating})</span>
                  </div>
                  <div className="flex flex-wrap gap-1 mb-4">
                    {product.tags.slice(0, 3).map((tag) => (
                      <span key={tag} className="text-xs bg-gray-100 text-charcoal-light px-2 py-1 rounded">
                        {tag}
                      </span>
                    ))}
                  </div>
